...
scrollSlide.prototype={
    ...
    startFnc:function(event){
        ...
        self.startpoi = self.horizontal?event.touches[0].pageX:event.touches[0].pageY;
    ...
    touchFnc:function(event){
        ...
        self.distancepoi = (self.horizontal?event.touches[0].pageX:event.touches[0].pageY) - self.startpoi;
